...
public class InventoryLogic:InterfaceInventoryLogic
{
    private readonly InterfaceInventoryDao inventoryDao;

    public InventoryLogic(InterfaceInventoryDao inventoryDao)
    {
